         ...
         <div id="list_back">
            <i style="font-size:35px;color: white;float: right;margin-right:30px;margin-top: 10px" onclick="toliked()" class="fas fa-heart"></i>
             ...
             <i style="font-size:35px;color: white;float: right;margin-right:-35px;margin-top: 65px" onclick="totrash()" class="fas fa-trash-alt"></i>
              ...
              <a href="add.php" > <i style="font-size:35px;color: white;float: right;margin-right:-35px;margin-top: 125px" class="fa fa-plus"></i> </a>
...
// Create connection$host = 'webapp-sql1';  //the name of the mysql service inside the docker file.
        $host = 'webapp-sql1';
        $user = 'devuser';
        $password = 'devpass';
        $db = 'audio';
